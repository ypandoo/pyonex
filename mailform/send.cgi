...
#06.設置者のアドレス(カンマ区切り)
$conf{'mailto'} = 'customerservice@seirin.jp';

#07.送信完了時にリダイレクトするサンクスページ
$conf{'thanks'} = 'http://kidolin.chicappa.jp/test2017/pyonex/thanks.html';

#08.設置者に届くメールの件名
$conf{'subject'} = '英語サイトからお問い合わせがありました。';

#09.送信者に届くメールの件名
$conf{'res_subject'} = '[SEIRIN CORPORATION] Thank you for contacting us!';

#10.送信者に届くメールの本文
$conf{'res_body'} = <<'__res_body_eof__';
Thank you for your contacting us.
A sales representative from my company will contact you later.
...
1007-1 Sodeshicho, Shimizu-ku, Shizuoka City, 
Shizuoka 424-0037, Japan
General office

http://global.seirin.jp
